  ...
  const featureBlocks = [
    {
      ...
      title: "Mua - Bán Pi",
      description: "Giao dịch tại thời điểm báo giá",
    ...
    },
    {
      ...
      description: "Đóng góp từ thiện và ủng hộ bằng Pi",
    ...
    },
    {
      ...
      description: "Tìm địa điểm trao đổi Pi gần bạn",
      gradient: "from-cyan-500 to-blue-500",
      action: () => router.push("/exchange?category=locations"),
    },
  ]
        ...
        <div className="grid grid-cols-2 gap-3 max-w-4xl mx-auto">
          {featureBlocks.map((block) => (
            <button
              ...
              className="flex flex-col p-4 rounded-2xl bg-white hover:shadow-xl transition-all duration-300 border border-purple-100/50 text-left group"
            >
              <div className="flex items-start gap-3">
                <div
                  className={`h-12 w-12 rounded-xl bg-gradient-to-br ${block.gradient} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300 flex-shrink-0`}
                >
                  {block.icon}
                </div>
                <div className="flex-1 min-w-0">
                  <h3 className="text-sm font-bold text-gray-800 mb-0.5 leading-tight">{block.title}</h3>
