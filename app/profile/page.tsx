...
export default function ProfilePage() {
  ...
  // Mock data for professional profile (UI only)
  const profileData = {
    username: user?.username || "mrjqka",
    displayName: user?.username || "mrjqka",
    handle: `@${user?.username || "mrjqka"}`,
    avatar: "π",
    isProvider: true, // Change based on user role
    isTrusted: true,
    isVerified: true,
    rating: 4.8,
    reviewCount: 127,
    ...
    joinDate: "01/2024",
    bio: "Chuyên cung cấp sản phẩm chất lượng cao, giao dịch uy tín. Tích cực trong cộng đồng Pi Network.",
    categories: ["Điện tử", "Thời trang", "Gia dụng"],
    businessName: "MRJQKA Store",
    businessDesc: "Cửa hàng đa dạng sản phẩm chất lượng",
    contactInfo: "pi://mrjqka",
    workingHours: "9:00 - 21:00 hàng ngày",
    businessAddress: "132 Lê Quang Định, P.14, Q.Bình Thạnh",
  }
