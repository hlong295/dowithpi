...
export default function AdminRescueEditPage({ params }: { params: { id: string } }) {
  ...
  return (
    <AdminShell title={`Cứu vườn — Edit ${params.id}`}> 
        ...
        {!item ? (
          ...
          <>
            ...
            <div className="grid gap-2">
              ...
              <Input value={item.category_id || ""} onChange={(e) => setItem({ ...item, category_id: e.target.value })} />
            </div>
              ...
              <Button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    router.replace("/admin/content/rescue");
                  } catch (e: any) {
