...
export async function GET(req: Request) {
  try {
    ...
    const baseSelect =
      "id,email,full_name,phone,pi_username,user_type,user_role,provider_approved,provider_approved_at,provider_business_name,provider_description,created_at,provider_label";
