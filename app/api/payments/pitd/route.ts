...
function buildSqlHintForRpc(): string[] {
  return [
    ...
    "ALTER FUNCTION public.pitd_purchase(uuid, numeric, uuid, text) OWNER TO postgres;",
    "REVOKE ALL ON FUNCTION public.pitd_purchase(uuid, numeric, uuid, text) FROM PUBLIC;",
