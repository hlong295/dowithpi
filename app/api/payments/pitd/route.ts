...
export async function POST(request: Request) {
  try {
    ...
    if (canaryErr) {
      ...
      const hintPermDenied = `DB đang REVOKE/GRANT sai nên service_role không đọc được pitd_wallets. Chạy SQL 1 lần trên Supabase SQL Editor:
GRANT USAGE ON SCHEMA public TO service_role;
GRANT SELECT, INSERT, UPDATE ON public.pitd_wallets TO service_role;
GRANT SELECT, INSERT ON public.pitd_transactions TO service_role;
