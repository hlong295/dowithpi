// NOTE: Edge runtime đôi khi gặp hạn chế mạng/timeout khi gọi Pi Platform API.
// Dùng Node.js runtime để approve ổn định trong "approval window" của Pi Wallet.
...
export async function POST(request: NextRequest) {
  try {
    ...
    const resp = await fetch(url, {
      method: "POST",
      headers: {
        // Pi Platform expects: Authorization: Key <PI_API_KEY>
