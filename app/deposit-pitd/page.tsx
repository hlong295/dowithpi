    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-50 pb-20">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          <Button variant="ghost" onClick={() => router.back()} className="mb-6 gap-2 hover:bg-blue-100 text-blue-00">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 text-center space-y-6">
            <div className="flex justify-center">
              <div className="h-24 w-24 rounded-3xl bg-gradient-to-br from-amber-400 via-yellow-500 to-amber-600 flex items-center justify-center shadow-lg p-5">
                <img src="/ICON_PITD_50x50.png" alt="PITD Token" className="h-full w-full object-contain" />
              </div>
            </div>
            ...
            <div className="space-y-3 py-6 border-y border-amber-100">
              <p className="text-lg text-gray-700 leading-relaxed">Xin chào chào khách!</p>
            ...
            <Button
              onClick={() => router.push("/")}
              className="bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-600 hover:to-yellow-600 text-white px-8 py-6 rounded-xl text-base font-semibold shadow-lg hover:shadow-xl transition-all duration-300 gap-2"
            >
