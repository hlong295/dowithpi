...
// Compatibility wrapper: some parts of the app call ensureUserOnce(...)
// to dedupe /api/auth/ensure-user calls. Keep it as a thin wrapper.
async function ensureUserOnce(sessionUser: any) {
  return ensurePiUserRecord(sessionUser)
}
