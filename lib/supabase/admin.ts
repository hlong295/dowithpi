...
import { STUDIO_SUPABASE_SERVICE_ROLE_KEY } from "@/lib/supabase/server-secrets"
...
const SERVICE_ROLE_KEY =
  ...
  // Pi App Studio / pinet hosting usually has no env injection.
  // Keep a SERVER-ONLY fallback that the developer can paste locally.
