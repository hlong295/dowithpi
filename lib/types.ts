...
export type PiUser = {
  ...
  // Admin-controlled labels (Phase 1.3/1.4)
  memberLabel?: "normal" | "trusted"
  providerLabel?: "unverified" | "verified" | "trusted"
}
...
export type Offer = {
  ...
  /** If false: PITD exchange button is hidden and direct contact info is shown instead. */
  pitdPaymentEnabled?: boolean
  directContactName?: string
  directContactPhone?: string
  directContactAddress?: string
...
export type Product = {
  ...
  marketingLabel?: string
  // P1.1: Item type (no UI changes; inferred from DB fields when missing)
  itemType?: "physical" | "voucher" | "digital"
}
