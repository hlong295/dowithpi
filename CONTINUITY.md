...
- Current patch: dowithpi_perf_pibrowser_fix03_lazy_supabase_PATCH03 (fix Pi Studio infinite auth loading; restore initializeAuth + listener; add getSession timeout).
