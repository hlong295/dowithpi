...
- Done:
  ...
  - Pi App Studio compatibility: render /buy-sell-pi **client-only (ssr:false)** to avoid "Application error: a client-side exception"; added an error boundary that shows a small on-screen debug message only if the page crashes.
