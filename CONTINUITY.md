...
- Done:
  ...
  - ADD: Bật/tắt **thanh toán PITD** cho từng sản phẩm (pitd_payment_enabled). Nếu tắt → không hiện nút đổi PITD, thay bằng thông tin liên hệ nhà cung cấp.
  - ADD: Form đăng/sửa sản phẩm (Admin + Provider): thêm Switch “Thanh toán bằng PITD” và khi tắt sẽ hiện các trường liên hệ: Tên / SĐT / Địa chỉ / Ghi chú.
  - DB: thêm các cột products: pitd_payment_enabled, direct_contact_name/phone/address/note (file sql/20260112_add_pitd_payment_mode.sql).
  - FIX: Trang chi tiết sản phẩm (app/product/[id]/page.tsx) map đầy đủ các field pitd_payment_enabled + direct_contact_* để hiển thị block liên hệ khi tắt PITD payment.
  - FIX: Đổi wording ở block PITD khi tắt PITD payment -> “Thanh toán PITD trực tiếp với nhà cung cấp. Vui lòng liên hệ.”
