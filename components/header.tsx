        ...
        <div className="flex h-11 items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <button
              ...
              className="relative flex items-center justify-center h-9 w-9 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105"
            >
