      ...
      <div className="container mx-auto px-3">
        <div className="flex h-11 items-center justify-between gap-3">
          ...
          <button onClick={() => router.push("/")} className="flex items-center gap-1.5 flex-shrink-0">
            <div className="h-7 w-7 rounded-xl overflow-hidden shadow-lg shadow-purple-500/30 bg-white/20">
              <Image src="/dowithpi-logo.png" alt="DOWITHPI" width={28} height={28} className="h-7 w-7 object-cover" />
            </div>
