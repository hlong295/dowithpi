...
import { Search, Gift, Star, User } from "lucide-react"
...
import { AccountHubSheet } from "@/components/account/AccountHubSheet"
...
export function Header() {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-3">
          <div className="flex h-11 items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              {/* Avatar Button - Opens AccountHub */}
              <button
                onClick={() => setIsAccountHubOpen(true)}
                className="flex items-center justify-center h-9 w-9 bg-white/90 backdrop-blur-md rounded-full shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105"
              >
      ...
      {/* AccountHubSheet - Opens from avatar button */}
      <AccountHubSheet isOpen={isAccountHubOpen} onClose={() => setIsAccountHubOpen(false)} />
    </>
  )
}
// </CHANGE>
